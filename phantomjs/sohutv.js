...
page.open('http://store.tv.sohu.com/content/5298003/1107749/2241/',function(status) {
   if(status != 'success') {
      console.log("error to open the page");
         ...
         page.evaluate(function() {
            ...
            var sohuplayer = document.getElementById('sohuplayer');
            console.log(sohuplayer.getAttribute("style"));
