...
##
#Multi interfaces version. Use 2 TCP conn
#It's fixed in easy interfaces version. So it's just for reference later
#
require "rubygems"
require "curb"
require "xmlsimple"
...
total_packets = 0
m.perform do
    #puts "Connect Time " + c.connect_time.to_s
    puts "Total Time " +  c.total_time.to_s if verbose
    total_packets += 1
...
puts "Summmary : total bytes " + total_bytes.to_s 
